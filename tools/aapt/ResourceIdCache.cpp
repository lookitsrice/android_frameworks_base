// // Copyright 2012 The Android Open Source Project // // Manage a resource ID cache.
#define LOG_TAG "ResourceIdCache" include <utils/String16.h> include <utils/Log.h> include "ResourceIdCache.h" include <map>
using namespace std; static size_t mHits = 0; static size_t mMisses = 0; static size_t mCollisions = 0; static const size_t MAX_CACHE_ENTRIES = 2048; 
static const android::String16 TRUE16("1"); static const android::String16 FALSE16("0"); struct CacheEntry {
...
static map< uint32_t, CacheEntry > mIdMap; // djb2; reasonable choice for strings when collisions aren't particularly important static inline 
uint32_t hashround(uint32_t hash, int c) {
...
namespace android { static inline String16 makeHashableName(const android::String16& package,
...
// returns the resource ID being stored, for callsite convenience uint32_t ResourceIdCache::store(const android::String16& package,
        const android::String16& type,
        const android::String16& name,
        bool onlyPublic,
        uint32_t resId) {
